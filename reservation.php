            ...
            <form role="form" id="booking" data-toggle="validator">
                ...
                <div class="col-lg-12">
                    ...
                    if (isset($_GET['room_id'])){?>
                        ...
                        <div class="panel panel-default">
                            <div class="panel-heading">Room Information:
                              <!-- <a class="btn btn-secondary pull-right" href="index.php?room_mang">Replan</a>-->
                            </div>
                    ...
                    <?php } else{?>
                        <div class="panel panel-default">
                            <div class="panel-heading">Room Information:
                               <!-- <a class="btn btn-secondary pull-right" style="border-radius:0%" href="index.php?reservation">Replan</a> -->
                            </div>
                            <div class="panel-body">
                                <div class="form-group col-lg-6">
                                    <label>Room Type</label>
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="form-group col-lg-6">
                                ...
                                <select class="form-control" id="id_card_id" data-error="Select ID Card Type">
                            ...
                            <div class="form-group col-lg-6">
                                ...
                                <input type="text" class="form-control" placeholder="ID Card Number" id="id_card_no" required>
                                <div class="help-block with-errors"></div>
                            </div>
    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title text-center"><b>Room Reserved</b></h4>
            </div>
            <div class="modal-body">
                <div class="row">
                    <div class="col-lg-12">
                        <div class="alert bg-success alert-dismissable" role="alert"><em class="fa fa-lg fa-check-circle">&nbsp;</em>Room Successfully Reserved</div>
